...
function DebugDisplay({ className = "" }) {
  ...
  const log2 = useCallback((message) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `border rounded-lg overflow-hidden bg-background ${className}`, children: [
    /* @__PURE__ */ jsx("div", { className: "p-3 border-b bg-muted/50", children: /* @__PURE__ */ jsx("h3", { className: "font-medium", children: "Debug Console" }) }),
    /* @__PURE__ */ jsx(
      "div",
      {
        ref: debugLogRef,
...
import { useRef as useRef2, useState as useState2, useCallback as useCallback3, useEffect } from "react";
import {
  RTVIEvent as RTVIEvent2
} from "@think41/foundation-voice-client-js";
import { useRTVIClient as useRTVIClient2, useRTVIClientEvent as useRTVIClientEvent2 } from "@pipecat-ai/client-react";

// src/components/chats/ChatContext.tsx
import { createContext, useContext, useState, useCallback as useCallback2 } from "react";
import { jsx as jsx2 } from "react/jsx-runtime";
var ChatContext = createContext(void 0);
function ChatProvider({ children }) {
  const [messages, setMessages] = useState([]);
  const addMessage = useCallback2((type, text) => {
    const newMessage = {
  ...
  return /* @__PURE__ */ jsx2(ChatContext.Provider, { value: { messages, addMessage, clearMessages }, children });
}
function useChat() {
...
function ChatWindow({
  ...
  useRTVIClientEvent2(
    RTVIEvent2.TransportStateChanged,
    useCallback3((state) => {
      setIsConnected(state === "ready");
    }, [])
  );
  useRTVIClientEvent2(
    RTVIEvent2.UserTranscript,
    useCallback3(
      (data) => {
  ...
  const sendTextMessage = useCallback3(async () => {
  ...
  const handleKeyPress = useCallback3((e) => {
    if (e.key === "Enter" && !e.shiftKey) {
      e.preventDefault();
      sendTextMessage();
    }
  }, [sendTextMessage]);
  return /* @__PURE__ */ jsxs2("div", { className: `flex flex-col bg-[oklch(0.278_0.033_256.848)] overflow-hidden ${className}`, children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 min-h-0 w-[calc(100%+1rem)] -mr-4 pr-4 no-scrollbar", children: [
      /* @__PURE__ */ jsx3("style", { dangerouslySetInnerHTML: { __html: `
        ...
        ` } }),
      messages.length === 0 ? /* @__PURE__ */ jsx3("div", { className: "text-center text-neutral-500 py-8", children: "Start a conversation by typing a message below or speaking." }) : messages.map((message) => /* @__PURE__ */ jsxs2(
        "div",
        {
          className: `flex flex-col ${message.type === "user" ? "items-end" : "items-start"}`,
          children: [
            /* @__PURE__ */ jsx3("span", { className: `text-xs font-medium mb-1 ${message.type === "user" ? "text-violet-300" : "text-neutral-300"}`, children: message.type === "user" ? "You" : "Assistant" }),
            /* @__PURE__ */ jsx3("div", { className: "flex items-start gap-2.5", children: /* @__PURE__ */ jsxs2(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx3("p", { className: "text-xs text-neutral-400 mt-1 px-1", children: message.timestamp.toLocaleTimeString("en-US", {
                    hour: "numeric",
                    minute: "2-digit",
                    hour12: true
                  }).toLowerCase() })
    ...
    /* @__PURE__ */ jsx3("div", { className: "p-4 border-t border-neutral-700 bg-[oklch(0.278_0.033_256.848)]", children: /* @__PURE__ */ jsxs2("form", { onSubmit: handleSubmit, className: "flex gap-2 items-center", children: [
      /* @__PURE__ */ jsx3(
        "input",
        {
          type: "text",
...
// src/components/controls/MicControl.tsx
import { useRTVIClient as useRTVIClient3 } from "@pipecat-ai/client-react";
...
function MicControl({
  ...
  const [internalSubmitted, setInternalSubmitted] = useState3(false);
  ...
  const [isDemo, setIsDemo] = useState3(demoMode);
  const client = useRTVIClient3();
  ...
  return /* @__PURE__ */ jsx4("div", { className: cn("w-full py-4", className), children: /* @__PURE__ */ jsxs3("div", { className: "relative max-w-xl w-full mx-auto flex items-center flex-col gap-2", children: [
    /* @__PURE__ */ jsx4(
      "button",
      {
        className: cn(
        ...
        children: isConnecting ? /* @__PURE__ */ jsx4(
          "div",
          {
            className: "w-6 h-6 rounded-sm animate-spin bg-black dark:bg-white cursor-pointer pointer-events-auto",
            style: { animationDuration: "3s" }
          }
        ) : submitted ? /* @__PURE__ */ jsx4("div", { className: "w-6 h-6 rounded-full bg-red-500 animate-pulse" }) : /* @__PURE__ */ jsx4(Mic, { className: "w-6 h-6 text-black/70 dark:text-white/70" })
      }
    ),
    /* @__PURE__ */ jsx4(
      "span",
    ...
    /* @__PURE__ */ jsx4("div", { className: "h-4 w-64 flex items-center justify-center gap-0.5", children: [...Array(visualizerBars)].map((_, i) => /* @__PURE__ */ jsx4(
      "div",
      {
        className: cn(
    ...
    /* @__PURE__ */ jsx4("p", { className: "h-4 text-xs text-black/70 dark:text-white/70", children: isConnecting ? "Processing..." : submitted ? "Listening..." : "Click to speak" })
  ] }) });
}
...
import {
  createRTVIClient,
  LLMHelper as LLMHelper2
} from "@think41/foundation-voice-client-js";
import { useEffect as useEffect3, useState as useState4, useCallback as useCallback5 } from "react";
...
function CAIProvider({
  ...
  const initializeLLMHelper = useCallback5((client2) => {
    if (!client2.getHelper("llm")) {
      const llmHelper = new LLMHelper2({
        callbacks: {
  ...
  useEffect3(() => {
    const fetchClient = async () => {
      const client2 = await createRTVIClient(clientType, options);
  ...
  return /* @__PURE__ */ jsx5(RTVIClientProvider, { client, children });
}
...
import { useRTVIClientMediaTrack, useRTVIClientEvent as useRTVIClientEvent4 } from "@pipecat-ai/client-react";
import { RTVIEvent as RTVIEvent4 } from "@think41/foundation-voice-client-js";
...
var AudioVisualizer = ({
  ...
  const [audioContext, setAudioContext] = useState5(null);
  const [analyser, setAnalyser] = useState5(null);
  const [dataArray, setDataArray] = useState5(null);
  const animationRef = useRef3(0);
  const [isActive, setIsActive] = useState5(false);
  const [isBotSpeaking, setIsBotSpeaking] = useState5(false);
  const audioTrack = useRTVIClientMediaTrack("audio", participantType);
  useRTVIClientEvent4(
    RTVIEvent4.BotStartedSpeaking,
    () => {
...
import {
  useRTVIClient as useRTVIClient4,
  useRTVIClientTransportState
} from "@pipecat-ai/client-react";
import { RTVIEvent as RTVIEvent5 } from "@think41/foundation-voice-client-js";
function useConnectionManager(options = {}) {
  const client = useRTVIClient4();
  ...
  const [connectionState, setConnectionState] = useState6({
    isConnected: false,
    isConnecting: false,
  ...
  const calculateReconnectDelay = useCallback6(
    (attempts) => {
  ...
  useEffect5(() => {
    ...
    client.on(RTVIEvent5.Disconnected, handleDisconnect);
    client.on(RTVIEvent5.Error, handleError);
    return () => {
      client.off(RTVIEvent5.Disconnected, handleDisconnect);
      client.off(RTVIEvent5.Error, handleError);
    };
  }, [
    client,
...
import { useRTVIClient as useRTVIClient5, useRTVIClientEvent as useRTVIClientEvent5 } from "@pipecat-ai/client-react";
import { RTVIEvent as RTVIEvent6 } from "@think41/foundation-voice-client-js";
...
function useConversationState() {
  const client = useRTVIClient5();
  const [currentState, setCurrentState] = useState7(
    "idle" /* IDLE */
  );
  const [isBotSpeaking, setIsBotSpeaking] = useState7(false);
  const [isUserSpeaking, setIsUserSpeaking] = useState7(false);
  const [isBotProcessing, setIsBotProcessing] = useState7(false);
  const [transcripts, setTranscripts] = useState7([]);
  const [lastUserTranscript, setLastUserTranscript] = useState7(
    null
  );
  const [lastBotTranscript, setLastBotTranscript] = useState7(
    null
  );
  const transitionTo = (newState) => {
    setCurrentState(newState);
  };
  useRTVIClientEvent5(RTVIEvent6.BotStartedSpeaking, () => {
    setIsBotSpeaking(true);
    log.conversation.info("Bot started speaking (RTVIEvent)");
    transitionTo("bot_speaking" /* BOT_SPEAKING */);
  });
  useRTVIClientEvent5(RTVIEvent6.BotStoppedSpeaking, () => {
    setIsBotSpeaking(false);
  ...
  useRTVIClientEvent5(RTVIEvent6.UserStartedSpeaking, () => {
    setIsUserSpeaking(true);
    log.conversation.info("User started speaking");
    transitionTo("user_speaking" /* USER_SPEAKING */);
  });
  useRTVIClientEvent5(RTVIEvent6.UserStoppedSpeaking, () => {
    setIsUserSpeaking(false);
    log.conversation.info("User stopped speaking");
    transitionTo("bot_processing" /* BOT_PROCESSING */);
    setIsBotProcessing(true);
  });
  useRTVIClientEvent5(RTVIEvent6.BotLlmStarted, () => {
    setIsBotProcessing(true);
  });
  useRTVIClientEvent5(RTVIEvent6.BotLlmStopped, () => {
    setIsBotProcessing(false);
  });
  useRTVIClientEvent5(RTVIEvent6.UserTranscript, (data) => {
    if (data?.text) {
      const transcript = {
        text: data.text,
        speaker: "user",
  ...
  useRTVIClientEvent5(RTVIEvent6.BotTranscript, (data) => {
    if (data?.text) {
      const transcript = {
        text: data.text,
        speaker: "bot",
...
import { useRTVIClient as useRTVIClient6, useRTVIClientEvent as useRTVIClientEvent6 } from "@pipecat-ai/client-react";
import { RTVIEvent as RTVIEvent7 } from "@think41/foundation-voice-client-js";
...
function ConnectionButton({
  ...
  const client = useRTVIClient6();
  const [internalConnected, setInternalConnected] = useState8(false);
  ...
  useRTVIClientEvent6(RTVIEvent7.Connected, () => {
    setInternalConnected(true);
    setIsConnecting(false);
    onChange?.(true);
  });
  useRTVIClientEvent6(RTVIEvent7.Disconnected, () => {
